# Labor Pricing — Orchestrator Prompt
...
## Role
You are the Labor Pricing orchestrator for Basco Commercial Doors.
...
<!-- Reference: Per-door rate card now. Reverse-bid auction ESCALATED to 5.0 Doctrine. -->
